//This page is used to connect to the Metamask wallet
...
const MetamaskConnection = () => {
  ...
  //connectWalletHandler() is used to connect to the Metamask extension
  const connectWalletHandler = async () => {
    if (window.ethereum && window.ethereum.isMetaMask) {
      try {
        //Requesting for Metamask connection
        ...
        //Displying error if there is any error in connection
        setErrorMessage(error.message);
      }
    } else {
      //Displaying error if Metamask is not installed
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-200">
      <div className="flex flex-col items-center justify-center w-full h-full">
        <div className="bg-white opacity-90 rounded-lg shadow-xl p-8 max-w-lg text-center">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">
            Nike Shoe Marketplace
          </h1>
          <p className="text-gray-600 mb-8">
            Explore and purchase the best Nike sneakers.
          </p>
          {/* This button is used to trigger for Metamask connection */}
          <button
          ...
          {walletConnectionStatus && (
            <div className="flex justify-center">
              <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                <a href="/listallproducts">Shop Now</a>
              </button>
            </div>
          )}
